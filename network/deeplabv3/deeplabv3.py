...
class DeepLabv3Plus(nn.Module):
    def __init__(self, orig_resnet, dilate_scale=16, num_classes=2, output_dim=256):
        ...
        final_conv = nn.Conv2d(5, 4, kernel_size=1)
        ...
        # self.four_classifier = nn.Sequential(
        #     nn.Dropout(p=0.5),
        #     final_conv,
        #     nn.ReLU(inplace=True),
    ...
    def forward(self, x):
        ...
        #four_class_prediction = torch.flatten(self.four_classifier(prediction),1)



        # return prediction, representation, four_class_prediction
